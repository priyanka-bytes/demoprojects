...
<div class="page-title-bar">Update Ticket</div>
 <form:form method = "POST" action="${pageContext.request.contextPath}/ticket/docsaveComments" modelAttribute="ticketcomments">
 
 <input type="hidden" name="ticketId"  value="<%=session.getAttribute("ticketId")%>" />
 <input type="hidden" name="userId"  value="<%=session.getAttribute("counsellorId")%>" />
 <div class="elem">
